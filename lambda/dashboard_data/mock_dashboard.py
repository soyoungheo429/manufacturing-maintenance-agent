"""dashboard_data MVP 목데이터 — 프론트엔드 src/data/mockData.js와 동일 구조/값.

실제 연동 시 dashboard_data/lambda_function.py의 DynamoDB 조회 결과로 대체된다.
프론트와 스키마를 일치시키기 위해 카멜케이스 키(camelCase)를 그대로 유지한다.
"""
...
MOCK_EQUIPMENTS = [
    ...
    },
    {
        ...
        "maintenanceRec": {"similarCases": [], "recommendation": "정상 운전 중. 다음 정기보전일 준수.", "parts": []},
    },
    {
        "id": "H78901",
        "productType": "H",
